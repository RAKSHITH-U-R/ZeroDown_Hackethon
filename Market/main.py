...
def history_calc(data):
    head = ["market_id", "time_bucket", "new_listings_count", "sold_homes_count", "homes_sold_over_list_price_count",
            "median_list_price_psqft", "median_sale_price_psqft", "median_sale_price", "median_sale_to_list_ratio", "days_to_pending", "days_to_sell"]
    data = data_processing(data, head)
